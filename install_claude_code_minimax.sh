...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        *)
            ...
            echo "用法: $0 [-r|--region china|global]"
            exit 1
            ;;
    esac
done
...
echo -e "区域: ${YELLOW}$REGION_DISPLAY${NC}"
echo -e "API Base URL: ${YELLOW}$BASE_URL${NC}"
